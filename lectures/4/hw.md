...
---
(HW3_28)=
## Задание 28. Каталог книг в библиотеке
...
---
(HW3_32)=
## Задание 32. Учёт инвентаря спортивного зала
...
* Список содержит словари, каждый словарь — отдельный объект учёта (сотрудник, автомобиль, питомец и т. д.).
